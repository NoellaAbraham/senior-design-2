...
class Game2Lev04 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_game2_lev04)
        ...
        val offlineUri: Uri = Uri.parse("android.resource://$packageName/${R.raw.disgust_lev0}")
    ...
    private fun showContinueButton() {
        ...
        continueButton.setOnClickListener {
            val intent = Intent(this, Game2Lev05::class.java)
            startActivity(intent)

            val progress = 10
            val userID = (application as MyApp).userID
            saveProgressToDatabase(userID, 2, 6, progress)
            finish()
        }
    }
}
